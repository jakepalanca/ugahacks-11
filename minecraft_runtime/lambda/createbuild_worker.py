...
TEXT2IMAGE_FUNCTION = os.environ.get("TEXT2IMAGE_FUNCTION", "createbuild_text_to_image")
...
PIPELINE_BUCKET = os.environ.get("PIPELINE_BUCKET", "createbuild-pipeline")
HUNYUAN_IO_BUCKET = os.environ.get("HUNYUAN_IO_BUCKET", PIPELINE_BUCKET)
ARTIFACT_BUCKET = os.environ.get("ARTIFACT_BUCKET", PIPELINE_BUCKET)
