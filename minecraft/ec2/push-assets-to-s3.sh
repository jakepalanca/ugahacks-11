...
ASSET_BUCKET="${1:-hackathon-minecraft-67}"
...
aws s3 cp "${ROOT_DIR}/ec2/paper-user-data.sh" "s3://${ASSET_BUCKET}/${ASSET_PREFIX}/bootstrap/paper-user-data.sh" --region "${REGION}"
